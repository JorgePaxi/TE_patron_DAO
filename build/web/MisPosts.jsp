...
<html>
    ...
    <body>
        <p align="right"><a href="ControladorPosts">INICIO</a> 
            <c:if test="${sessionScope.id_usuario == 1}">| 
                ...
                &nbsp&nbsp<img src="Imagenes/user.png" width="30" height="30"> Usuario: <%= usuario%> |
            &nbsp&nbsp<img src="Imagenes/exit.png" width="30" height="30"><a href="login.jsp?cerrar=true"> Salir</a>
        </p>
        <hr>
    ...
    <c:forEach var="item" items="${post}">  
        <div>
            ...
            <h2><p style="color:red;">${item.titulo}</p></h2>
            <h3>${item.contenido}</h3><br>

            <h3><label style="color:blue;">Autor: </label>  
