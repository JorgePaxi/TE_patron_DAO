    ...
    <body>
        <p align="right"><a href="ControladorPosts">INICIO</a> 
            <c:if test="${sessionScope.id_usuario == 1}">| 
                ...
                &nbsp&nbsp<img src="Imagenes/user.png" width="25" height="25"> Usuario: <%= usuario%> |
            &nbsp&nbsp<img src="Imagenes/exit.png" width="25" height="25"><a href="login.jsp?cerrar=true"> Salir</a>
        </p>
        <hr>
